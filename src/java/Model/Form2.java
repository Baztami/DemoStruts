 ...
 * @author bazta
 */
public class Form2 extends org.apache.struts.action.DynaActionForm {
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ActionErrors errors = new ActionErrors();
         if(this.get("numCompte").toString()==null || this.get("numCompte").toString().trim().length()==0){
        ...
        if(this.get("solde").toString()==null || this.get("solde").toString().trim().length()==0 ){
